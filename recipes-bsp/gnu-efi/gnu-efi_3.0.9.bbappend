# emergency rollback to 3.0.9
# 3.0.11 breaks secure boot
# patch up to make it compatible with 3.0.11

FILESEXTRAPATHS_prepend := "${THISDIR}/${PN}:"
SRC_URI_append = " file://0001-EFI_WARN_UNKNOWN_GLYPH-fix-typo.patch"
