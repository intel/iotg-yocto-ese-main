...
SRC_URI = "https://gstreamer.freedesktop.org/src/gst-plugins-base/gst-plugins-base-${PV}.tar.xz \
           ...
           file://video-Move-Y410-into-the-correct-place-for-big-endian-pla.patch \
           file://0001-glimagesink-set-last-sample-disabled-if-input-is-ext.patch \
           file://0003-glupload-Add-a-comment-in-DMA-s-propose_allocation-q.patch \
           "
