...
SRC_URI = " \
    ...
    file://0001-h265parser-select-the-right-profile-for-high-through.patch \
    file://0002-h265parse-recognize-more-HEVC-extension-streams.patch \
    file://0001-msdk-add-support-for-AV1-decoding.patch \
    ...
    file://0003-codecparsers-av1-Fix-a-error-report-for-ITUT_T35-met.patch \
    file://0004-codecparsers-av1-Improve-the-loop-filter-setting.patch \
    file://0005-codecparsers-av1-delete-duplicated-GST_AV1_GM_ABS_AL.patch \
    file://0006-codecparsers-av1-uint8-range-is-not-enough-for-av1_b.patch \
    file://0007-codecparsers-av1-add-valid-check-for-global-motion-p.patch \
    file://0008-codecparsers-av1-Fix-a-typo-when-get-value-of-segmen.patch \
    file://0009-codecparsers-av1-Fix-a-tile-info-read-typo-in-frame-.patch \
    file://0010-codecparsers-av1-Improve-the-parse_tile_info.patch \
    file://0011-test-av1parser-update-the-test-result-because-of-bug.patch \
"

S = "${WORKDIR}/git"
SRCREV = "5ffd2c64a0cca7b55e280d61d225e45858bc4aa0"
