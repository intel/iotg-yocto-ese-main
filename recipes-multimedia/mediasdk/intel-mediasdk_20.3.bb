...
SRC_URI = "\
	git://github.com/Intel-Media-SDK/MediaSDK.git;protocol=https;nobranch=1 \
	...
	file://0001-sample_misc-Fix-video-suttering-during-wayland-rende.patch \
	"
...
EXTRA_OECMAKE += "-DMFX_INCLUDE=${S}/api/include -DBUILD_SAMPLES=ON -DENABLE_ITT=ON -DAPI=latest"
